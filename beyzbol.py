...
df = pd.read_csv("C:/Users/User/OneDrive/Masaüstü/Maas_Tahmin_Modeli-220805-074813/hitters.csv")
...
stats_num_cols = [col for col in num_cols if col not in ["Salary", "Years"]]
df[stats_num_cols] = df[stats_num_cols] + 1
